...
a) Denkleminizi **buraya yazınız:0,117+1,73x+1.14x^2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? Sizce niçin a'nın değeri negatif?**Cevap:2. dereceden denklemlerin grafikleri parabol oluşturur. Parabollarda a katsayısı parabol kollarının nasıl olacağını belirler. Eğer negatifse kollar aşağıya doğrudur. Bizim yaptığımız deneyde de tepe noktası üst kısımda ve kollar aşağıya doğru olduğu için negatiftir.a,b ve c nin fiziksel anlamları ise ivme/hız katsayısı ,sürtünme katsayısı ve kütleyle alakalı olabileceğini düşünüyorum**  
...
c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c)**Cevap:Bence daha hızlı atılsaydı hedefe ulaşacağı süre azalacağı için a sayısı küçülürdü.aynı zamanda konum değişmeyeceği için c artar,b ise atılma hızıyla orantılı olarak değişirdi.** 
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1HnPqD0zH5fxNiS2X7TluBvOm-zR1O8dG6FgeNkKrG3o/edit?usp=sharing) link veriniz.
...
1) Bu deneyde ölçüm hatalarım var. Zamandaki ölçüm hatam sizce kaç ms (mili saniye) nedir? Konumdaki ölçüm hatam sizce kaç cm'dir?**Cevap:Benim bulduğum değerler ile sizn değerlerininz arasında 0,02 m lik bir fark oluşuyor.** 
