...
a) Denkleminizi **buraya yazınız:0,117+1,73x+1.14x^2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? Sizce niçin a'nın değeri negatif?**Cevap:2. dereceden denklemlerin grafikleri parabol oluşturur. Parabollerde a katsayısı Eğer negatifse kollar aşağıya doğrudur. Bizim yaptığımız deneyde de tepe noktası üst kısımda ve kollar aşağıya doğru olduğu için negatiftir.a,b ve c nin fiziksel anlamları ise ivme/hız katsayısı ,sürtünme katsayısı ve kütleyle alakalı olabileceğini düşünüyorum**  
